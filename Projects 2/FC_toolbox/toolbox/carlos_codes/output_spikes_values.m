...
split_1.leaders = leaders;
split_1.global_coi = global_coi;
%save('/gdrive/public/USERS/aguilac/Projects/FC_toolbox/results/mat_output/split_1.mat','split_1'); %'-v7.3');
save('/Users/carlosaguila/PycharmProjects/CNT_Interictal_Spikes/Results_v1/split_1.mat'); %local machine
%% plot sequence
figure(1)
