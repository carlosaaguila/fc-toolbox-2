...
random = randi([6,146],1,10); %generates 20 random indexs to pull from
run_times_slice = run_times(1:6); %(random);
gdf_slice = gdf(1:6); %(random);
...
seqs_concat = {};
seqs_all = seqs_all(~cellfun('isempty',seqs_all)); %this removes any empty cell
...
save('/gdrive/public/USERS/aguilac/Projects/FC_toolbox/results/mat_output/split_HUP203.mat','struct','split_TEST');
%% plot sequence
%figure(1)
